...
const ElementsCde = () => {
  ...
  useEffect(() => {
    axios
      .get("htpps://lion-print.net/dernCommande")
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(`htpps://lion-print.net/recupDetComm/${num}`)
      .then((res) => {
        console.log(res.data);
  ...
  useEffect(() => {
    axios
      .get("htpps://lion-print.net/recupProds")
      .then((res) => {
        console.log(res.data);
        setProd(res.data);
      })
  ...
  const postDetCom = (e) => {
    e.preventDefault();
    axios
      .post("htpps://lion-print.net/destailCommande", value)
      .then((res) => {
        console.log(res.data);
        setShowModal(false);
  ...
  const terminerCde = (e) => {
    e.preventDefault();
    axios
      .put("htpps://lion-print.net/terminerCde/" + num)
      .then((res) => {
        console.log(res.data);
        navigate("/list-cdes");
      })
